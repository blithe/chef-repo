...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "blithe-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/blithe"
  #   chef.validation_client_name = "blithe-validator"
  #   chef.validation_key_path = ".chef/blithe-validator.pem"
  # end
end
